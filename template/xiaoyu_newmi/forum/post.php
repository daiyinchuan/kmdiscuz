...
<style>
.tbn li{border-top: 1px solid #f5f7fa;border-bottom:none;height: 50px;line-height: 50px;padding-left: 40px;margin:0;}
.tbn li.a{border-bottom: 1px solid #f5f7fa;height: 50px;line-height: 50px;padding-left: 40px;}
.tbn ul a{height:50px;line-height:50px;}
.tbn li.a{border-top:1px solid #f5f7fa}
.tbn li.a a{color:#f46344;}.tb{border-bottom: 1px solid #ecf0f0;margin:0 -35px 10px;padding:0 35px 15px;}
.tb a{background: #FFF;border:none;color:#909191;font-size:16px;font-weight:100;}
.tb .a a, .tb .current a{background: #fff;border-bottom-color: #fff;color:#f46344;font-weight:100;}
</style>
...
<div id="ct" class="ct2_a ct2_a_r wp xiaoyu_post cl">
