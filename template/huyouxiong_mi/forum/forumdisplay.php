...
<div class="wp">
	<!--[diy=diy1]--><div id="diy1" class="area"></div><!--[/diy]-->
			...
			<!--{if $comiis_list_xpic==0 && $_G[forum][banner] && !$subforumonly}--><img src="$_G[forum][banner]" alt="$_G['forum'][name]" /><!--{/if}-->
			<!--{if $comiis_list_xpic==1 || $comiis_list_xpic==2}-->
			<div class="comiis_pn_post cl"<!--{if $comiis_list_xpic==2 && !($_G[forum][banner] && !$subforumonly)}--> style="padding-top:0;"<!--{/if}-->>
				<span class="y">
			...
			<!--{/if}-->
			<div class="comiis_listinfo cl gwrl"<!--{if $comiis_list_xpic==0 || ($comiis_list_xpic==2 && !($_G[forum][banner] && !$subforumonly))}--> style="padding:15px 10px 15px 15px;margin-bottom:10px;"<!--{/if}-->>
			 <!--{if $comiis_list_xpic==1 || ($comiis_list_xpic==2 && $_G[forum][banner] && !$subforumonly)}-->
				<!--{if $_G[forum][banner] && !$subforumonly}--><div class="topico"><img src="$_G[forum][banner]" alt="$_G['forum'][name]" /></div><!--{else}--><div class="topico"><img src="{$_G['style']['styleimgdir']}/comiis_nofid.gif" alt="$_G['forum'][name]" /></div><!--{/if}-->
			<!--{/if}-->
				...
				<!--{/if}-->
					<div><!--{if $_G[forum][description]}-->{$_G[forum][description]}<!--{else}-->暂无简介, 请在后台版块管理中添加!<!--{/if}--></div>
				<!--{if !empty($forumarchive)}-->
			...
			<!--{if !$subforumonly}-->
				...
				<!--{if ($_G['forum']['threadtypes'] && $_G['forum']['threadtypes']['listable']) || count($_G['forum']['threadsorts']['types']) > 0}-->
					<ul id="thread_types" class="ttp bm comiis_types cl">
						...
						<li id="ttp_all"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]{if $_G['forum']['threadsorts']['defaultshow']}&filter=sortall&sortall=1{/if}{if $_GET['archiveid']}&archiveid={$_GET['archiveid']}{/if}"><!--{if $comiis_list_types_ico==1}--><img src="{$_G['style']['styleimgdir']}/comiis_types_ico.png" /><!--{/if}-->{lang forum_viewall}</a></li>
						<!--{if $_G['forum']['threadtypes']}-->
							<!--{loop $_G['forum']['threadtypes']['types'] $id $name}-->
								<!--{if $_GET['typeid'] == $id}-->
								<li class="a"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]{if $_GET['sortid']}&filter=sortid&sortid=$_GET['sortid']{/if}{if $_GET['archiveid']}&archiveid={$_GET['archiveid']}{/if}" title="<!--{if $showthreadclasscount[typeid][$id]}-->{$showthreadclasscount[typeid][$id]}<!--{else}-->0<!--{/if}-->篇主题"><!--{if $_G[forum][threadtypes][icons][$id]}--><img src="$_G[forum][threadtypes][icons][$id]" alt="" /><!--{elseif $comiis_list_types_ico==1}--><img src="{$_G['style']['styleimgdir']}/comiis_types_ico.png" /><!--{/if}-->$name</a></li>
								<!--{else}-->
						...
						<!--{if $_G['forum']['threadsorts']}-->
							...
							<!--{loop $_G['forum']['threadsorts']['types'] $id $name}-->
								<!--{if $_GET['sortid'] == $id}-->
								<li class="xw1 a"><a href="forum.php?mod=forumdisplay&fid=$_G[fid]{if $_GET['typeid']}&filter=typeid&typeid=$_GET['typeid']{/if}{if $_GET['archiveid']}&archiveid={$_GET['archiveid']}{/if}" title="<!--{if $showthreadclasscount[sortid][$id]}-->{$showthreadclasscount[sortid][$id]}<!--{else}-->0<!--{/if}-->篇主题"><!--{if $comiis_list_types_ico==1}--><img src="{$_G['style']['styleimgdir']}/comiis_types_ico.png" /><!--{/if}-->$name</a></li>
								<!--{else}-->
								<li><a href="forum.php?mod=forumdisplay&fid=$_G[fid]&filter=sortid&sortid=$id$forumdisplayadd[sortid]{if $_GET['archiveid']}&archiveid={$_GET['archiveid']}{/if}" title="<!--{if $showthreadclasscount[sortid][$id]}-->{$showthreadclasscount[sortid][$id]}<!--{else}-->0<!--{/if}-->篇主题"><!--{if $comiis_list_types_ico==1}--><img src="{$_G['style']['styleimgdir']}/comiis_types_ico.png" /><!--{/if}-->$name</a></li>
								<!--{/if}-->
							<!--{/loop}-->
						<!--{/if}-->
