...
<div id="ct" class="wp cl{if $comiis_forum_right==1} ct2{/if}">
	<!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
		...
		<!--{/if}-->
		<!--{hook/index_top}-->
	<div class="mn comiis_rollzbox kmfn">
	...
	<!--{if $comiis_forum_right==1}-->
		<div id="sd" class="sd comiis_main_r comiis_rollybox">
			<div id="comiis_rollbox">
				<div class="comiis_brbox_fatie cl"><a href="forum.php?mod=misc&action=nav" onclick="showWindow('nav', this.href, 'get', 0)"><i></i>发表新主题</a></div>	
...
<script>
	jQuery("td.fl_g").hover(function(){
		jQuery(this).addClass("kmshover");
	},function(){
		jQuery(this).removeClass("kmshover");
	});
</script>
