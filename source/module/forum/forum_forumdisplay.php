...
$extra = rawurlencode(!IS_ROBOT ? 'page='.$page.($forumdisplayadd['page'] ? '&filter='.$filter.$forumdisplayadd['page'] : '') : 'page=1');if($_GET['filter'] == 'digest') {	$forumdisplayadd['lastpost']="";}
//var_dump($forumdisplayadd);
$separatepos = 0;
